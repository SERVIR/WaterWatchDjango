...
def translation_dictionary(lang):
    if lang == 'fr': return {
        ...
        'all_layers': '''Couches''',
        'chart_viewFullscreen': '''Afficher en plein écran''',
        'chart_printChart': '''Imprimer le graphique''',
        'chart_downloadPNG': '''Télécharger l'image PNG''',
        'chart_downloadJPEG': '''Télécharger l'image JPEG''',
        'chart_downloadPDF': '''Télécharger le fichier PDF''',
        'chart_downloadSVG': '''Télécharger l'image vectorielle SVG''',
        'chart_downloadCSV': '''Télécharger CSV''',
        'chart_downloadXLS': '''Télécharger XLS''',
        'chart_viewData': '''Afficher le tableau de données''',
        'chart_all': '''Tous''',
        'chart_1month': '''Voir 1 mois''',
        'chart_3month': '''Voir 3 mois''',
        ...
        'all_banner': '''Information sur l'étang mise à jour le ''',
        }
    if lang == 'en': return {
        ...
        'all_layers': '''Layers''',
        'chart_viewFullscreen': '''View Full Screen''',
        'chart_printChart': '''Print Chart''',
        'chart_downloadPNG': '''Download PNG image''',
        'chart_downloadJPEG': '''Download JPEG image''',
        'chart_downloadPDF': '''Download PDF file''',
        'chart_downloadSVG': '''Download SVG Vector image''',
        'chart_downloadCSV': '''Download CSV''',
        'chart_downloadXLS': '''Download XLS''',
        'chart_viewData': '''View data table''',
        'chart_all': '''All''',
        'chart_1month': '''1 month''',
        'chart_3month': '''3 months''',
        ...
        'all_banner': '''Pond information updated on ''',
        }
